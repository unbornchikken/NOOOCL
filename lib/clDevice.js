...
Object.defineProperties(CLDevice.prototype, {
    ...
    deviceType: {
        get: function () {
            return this._getInfo(nodecl.Type.deviceType, this.cl.DEVICE_TYPE);
        }
    },
    ...
    vendorID: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_VENDOR_ID);
        }
    },
    ...
    maxWorkItemDimensions: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MAX_WORK_ITEM_DIMENSIONS);
        }
    },
    ...
    maxWorkItemSizes: {
        get: function () {
            return this._getArrayInfo(Signature.size, this.cl.DEVICE_MAX_WORK_ITEM_SIZES);
        }
    },
    ...
    maxWorkgroupSize: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_MAX_WORK_GROUP_SIZE);
        }
    },
    ...
    maxClockFrequency: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MAX_CLOCK_FREQUENCY);
        }
    },
    ...
    addressBits: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_ADDRESS_BITS);
        }
    },
    ...
    maxMemAllocSize: {
        get: function () {
            return this._getInfo(Signature.uint64, this.cl.DEVICE_MAX_MEM_ALLOC_SIZE);
        }
    },
    ...
    imageSupport: {
        get: function () {
            return this._getInfo(Signature.bool, this.cl.DEVICE_IMAGE_SUPPORT);
        }
    },
    ...
    maxReadImageArgs: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MAX_READ_IMAGE_ARGS);
        }
    },
    ...
    maxWriteImageArgs: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MAX_WRITE_IMAGE_ARGS);
        }
    },
    ...
    image2DMaxWidth: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_IMAGE2D_MAX_WIDTH);
        }
    },
    ...
    image2DMaxHeight: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_IMAGE2D_MAX_HEIGHT);
        }
    },
    ...
    image3DMaxWidth: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_IMAGE3D_MAX_WIDTH);
        }
    },
    ...
    image3DMaxHeight: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_IMAGE3D_MAX_HEIGHT);
        }
    },
    ...
    image3DMaxDepth: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_IMAGE3D_MAX_DEPTH);
        }
    },
    ...
    maxSamplers: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MAX_SAMPLERS);
        }
    },
    ...
    maxParameterSize: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_MAX_PARAMETER_SIZE);
        }
    },
    ...
    memBaseAddrAlign: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MEM_BASE_ADDR_ALIGN);
        }
    },
    ...
    minDataTypeAlignSize: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MIN_DATA_TYPE_ALIGN_SIZE);
        }
    },
    ...
    singleFpConfig: {
        get: function () {
            return this._getInfo(nodecl.Type.deviceFpConfig, this.cl.DEVICE_SINGLE_FP_CONFIG);
        }
    },
    ...
    doubleFpConfig: {
        get: function () {
            return this._getInfo(nodecl.Type.deviceFpConfig, this.cl.DEVICE_DOUBLE_FP_CONFIG);
        }
    },
    ...
    globalMemCacheType: {
        get: function () {
            return this._getInfo(nodecl.Type.deviceMemCacheType, this.cl.DEVICE_GLOBAL_MEM_CACHE_TYPE);
        }
    },
    ...
    globalMemCacheLineSize: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_GLOBAL_MEM_CACHELINE_SIZE);
        }
    },
    ...
    globalMemCacheSize: {
        get: function () {
            return this._getInfo(Signature.uint64, this.cl.DEVICE_GLOBAL_MEM_CACHE_SIZE);
        }
    },
    ...
    globalMemSize: {
        get: function () {
            return this._getInfo(Signature.uint64, this.cl.DEVICE_GLOBAL_MEM_SIZE);
        }
    },
    ...
    maxConstBufferSize: {
        get: function () {
            return this._getInfo(Signature.uint64, this.cl.DEVICE_MAX_CONSTANT_BUFFER_SIZE);
        }
    },
    ...
    maxConstArgs: {
        get: function () {
            return this._getInfo(Signature.uint, this.cl.DEVICE_MAX_CONSTANT_ARGS);
        }
    },
    ...
    localMemType: {
        get: function () {
            return this._getInfo(nodecl.Type.deviceLocalMemType, this.cl.DEVICE_LOCAL_MEM_TYPE);
        }
    },
    ...
    localMemSize: {
        get: function () {
            return this._getInfo(Signature.uint64, this.cl.DEVICE_LOCAL_MEM_SIZE);
        }
    },
    ...
    errorCorrectionSupport: {
        get: function () {
            return this._getInfo(Signature.bool, this.cl.DEVICE_ERROR_CORRECTION_SUPPORT);
        }
    },
    ...
    hostUnifiedMemory: {
        get: function () {
            return this._getInfo(Signature.bool, this.cl.DEVICE_HOST_UNIFIED_MEMORY);
        }
    },
    ...
    profilingTimerResolution: {
        get: function () {
            return this._getInfo(Signature.size, this.cl.DEVICE_PROFILING_TIMER_RESOLUTION);
        }
    },
    ...
    littleEndian: {
        get: function () {
            return this._getInfo(Signature.bool, this.cl.DEVICE_ENDIAN_LITTLE);
        }
    },
    ...
    available: {
        get: function () {
            return this._getInfo(Signature.bool, this.cl.DEVICE_AVAILABLE);
        }
    },
    ...
    compilerAvailable: {
        get: function () {
            return this._getInfo(Signature.bool, this.cl.DEVICE_COMPILER_AVAILABLE);
        }
    },
    ...
    deviceExecCapabilities: {
        get: function () {
            return this._getInfo(nodecl.Type.deviceExecCapabilities, this.cl.DEVICE_EXECUTION_CAPABILITIES);
        }
    },
    ...
    commandQueueProperties: {
        get: function () {
            return this._getInfo(nodecl.Type.commandQueueProperties, this.cl.DEVICE_QUEUE_PROPERTIES);
        }
    },
    ...
    name: {
        get: function () {
            return this._getStringInfo(this.cl.DEVICE_NAME);
        }
    },
    ...
    vendor: {
        get: function () {
            return this._getStringInfo(this.cl.DEVICE_VENDOR);
        }
    },
    ...
    driverVersion: {
        get: function () {
            return this._getStringInfo(this.cl.DRIVER_VERSION);
        }
    },
    ...
    profile: {
        get: function () {
            return this._getStringInfo(this.cl.DEVICE_PROFILE);
        }
    },
    ...
    clVersion: {
        get: function () {
            return this._getStringInfo(this.cl.DEVICE_VERSION);
        }
    },
    ...
    clCVersion: {
        get: function () {
            return this._getStringInfo(this.cl.DEVICE_OPENCL_C_VERSION);
        }
    },
    ...
    extensions: {
        get: function () {
            return this._getStringInfo(this.cl.DEVICE_EXTENSIONS);
        }
    }
});
