...
Object.defineProperties(CLDevice.prototype, {
    ...
    maxMemAllocSize: {
        get: function () {
            return this._getInfo(Signature.ulong, this.cl.DEVICE_MAX_MEM_ALLOC_SIZE);
        }
    },
    ...
    singleFpConfig: {
        get: function () {
            return this._getInfo(nodecl.Type.device_fp_config, this.cl.DEVICE_SINGLE_FP_CONFIG);
        }
    },
    ...
    doubleFpConfig: {
        get: function () {
            return this._getInfo(nodecl.Type.device_fp_config, this.cl.DEVICE_DOUBLE_FP_CONFIG);
        }
    },
    ...
    globalMemCacheType: {
        get: function () {
            return this._getInfo(nodecl.Type.device_mem_cache_type, this.cl.DEVICE_GLOBAL_MEM_CACHE_TYPE);
        }
    },
    ...
    globalMemCacheSize: {
        get: function () {
            return this._getInfo(Signature.ulong, this.cl.DEVICE_GLOBAL_MEM_CACHE_SIZE);
        }
    },
    ...
    globalMemSize: {
        get: function () {
            return this._getInfo(Signature.ulong, this.cl.DEVICE_GLOBAL_MEM_SIZE);
        }
    },
    ...
    maxConstBufferSize: {
        get: function () {
            return this._getInfo(Signature.ulong, this.cl.DEVICE_MAX_CONSTANT_BUFFER_SIZE);
        }
    },
    ...
    localMemType: {
        get: function () {
            return this._getInfo(nodecl.Type.device_local_mem_type, this.cl.DEVICE_LOCAL_MEM_TYPE);
        }
    },
    ...
    localMemSize: {
        get: function () {
            return this._getInfo(Signature.ulong, this.cl.DEVICE_LOCAL_MEM_SIZE);
        }
    },
    ...
    deviceExecCapabilities: {
        get: function () {
            return this._getInfo(nodecl.Type.device_exec_capabilities, this.cl.DEVICE_EXECUTION_CAPABILITIES);
        }
    },
    ...
    commandQueueProperties: {
        get: function () {
            return this._getInfo(nodecl.Type.command_queue_properties, this.cl.DEVICE_QUEUE_PROPERTIES);
        }
    },
