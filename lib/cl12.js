...
function CL12() {
    ...
    _.extend(
        ...
        ffi.Library(this.libName,
        {
            ...
            //                            const cl_event *  /* event_wait_list */,
            //                            cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_2;
            clEnqueueMarkerWithWaitList: ['int', [types.CommandQueue, 'uint',
                    bridjs.byPointer(bridjs.NativeValue.pointer), bridjs.byPointer(bridjs.NativeValue.pointer)]],
