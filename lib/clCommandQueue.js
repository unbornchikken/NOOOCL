...
CLCommandQueue.prototype.enqueueMapImage = function(waitable, image, flags, origin, region, out, events) {
    ...
    var ptr = this.cl.imports.clEnqueueMapImage(this.handle, clUtils.toHandle(image.handle), false, flags, origin.sizes, origin.sizes, rowPitch, slicePitch, waitList.count, waitList.array, event, err);
    this.cl.checkError(err);
    out.ptr = ptr;
