...
Object.defineProperties(CLSampler.prototype, {
    ...
    normalizedCoords: {
        get: function () {
            return this._getInfo('bool', this.cl.defs.SAMPLER_NORMALIZED_COORDS);
        }
    },

    addressingMode: {
        get: function () {
            return this._getInfo(this.cl.types.AddressingMode, this.cl.defs.SAMPLER_ADDRESSING_MODE);
        }
    },

    filterMode: {
        get: function () {
            return this._getInfo(this.cl.types.FilterMode, this.cl.defs.SAMPLER_FILTER_MODE);
        }
    }
});
