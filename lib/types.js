...
var types = {
    ...
    CreateContextNotify: ref.refType("void"),
    BuildProgramNotify: ref.refType("void"),
    EnqueueNativeKernelUserFunc: ref.refType("void"),
    SetEventCallbackCallback: ref.refType("void"),
    MemObjectDestructorCallback: ref.refType("void")
