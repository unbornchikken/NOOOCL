...
Object.defineProperties(CLKernel.prototype, {
    ...
    name: {
        get: function() {
            return this._name ? this._name : this._getStringInfo(this.cl.defs.KERNEL_FUNCTION_NAME);
        }
    },
    context: {
        get: function () {
...
CLKernel.prototype.setArgs = function(args) {
    var self = this;
...
CLKernel.prototype.bind = function(queue, globalRange, localRange, offset) {
    return (function(waitable, args) {
        if (_.isUndefined(args)) {
            args = waitable;
            waitable = false;
        }
        this.setArgs(args);
        return queue.enqueueNDRangeKernel(waitable, this, globalRange, localRange, offset);
    }).bind(this);
}
