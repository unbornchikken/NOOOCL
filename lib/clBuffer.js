...
function CLBuffer1(context, flags, dataSize, hostPtr) {
    ...
    var handle = cl.imports.clCreateBuffer(context.handle, flags, dataSize, hostPtr, err);
    cl.checkError(err);
    CLMemory.call(this, context, handle);
}

function CLBuffer1(context, handle) {
    CLMemory.call(this, context, handle);
}
...
Object.defineProperties(CLBuffer.prototype, {
    ...
    superBuffer: {
        get: function() {
            var subHandle = this.getInfo(this.cl.types.Mem, this.cl.defs.MEM_ASSOCIATED_MEMOBJECT);
