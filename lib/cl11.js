    ...
    this.imports = new ffi.Library(this.libName,
        {
            ...
            //                      const cl_event *  /* event_wait_list */,
            //                      cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueNativeKernel: ["int", [types.CommandQueue, types.EnqueueNativeKernelUserFunc, "pointer", "size_t", "uint", types.MemArray, ref.refType("pointer"), "uint", types.EventArray, types.Event]],
