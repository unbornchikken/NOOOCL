...
Object.defineProperties(CLContext.prototype, {
    ...
    numDevices: {
        get: function () {
            ...
            return this._getInfo('uint', this.cl.defs.CONTEXT_NUM_DEVICES);
        }
    },
    devices: {
        get: function () {
            this._throwIfReleased();
            return this._getArrayInfo(this.cl.types.DeviceId, this.cl.defs.CONTEXT_DEVICES);
        }
    },
    contextProperties: {
        get: function () {
            this._throwIfReleased();
            return this._getArrayInfo('size_t', this.cl.defs.CONTEXT_PROPERTIES);
        }
    }
});
...
function createPropArray(cl, properties, platform) {
    ...
    var ptr = ref.address(clUtils.toHandle(platform));
