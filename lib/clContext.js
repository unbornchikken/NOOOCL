...
CLContext.prototype.supportedImageFormats = function (flags, type) {
    ...
    var err = this.cl.imports.clGetSupportedImageFormats(this.handle, flags, type, 0, null, bridjs.byPointer(numFormats));
    ...
    err = this.cl.imports.clGetSupportedImageFormats(this.handle, flags, type, num, bridjs.byPointer(resultArray), null);
