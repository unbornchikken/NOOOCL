...
function CLContext1(devices, properties) {
    ...
    var propArray = createPropArray(cl, properties, firstDevice.platform);

    var err = ref.alloc(cl.types.ErrorCode);
    var handle = cl.imports.clCreateContext(propArray, deviceCount, deviceArray, null, null, err);
...
CLContext.prototype.supportedImageFormats = function (flags, type) {
    var numFormats = ref.refType('uint').malloc();
