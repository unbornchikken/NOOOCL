    ...
    this.imports = ffi.Library(libName,
        {
            ...
            //                       const cl_event * /* event_wait_list */,
            //                       cl_event *       /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueNDRangeKernel: ['int', [types.CommandQueue, 'pointer', 'uint', types.SizeTArray, types.SizeTArray, types.SizeTArray, 'uint', types.EventArray, types.Event]],
            ...
            //                 cl_int *      /* errcode_ret */) CL_API_SUFFIX__VERSION_1_1;
            createUserEvent: [types.Event, [types.Context, ref.refType('int')]]
        });
}
...
CL11.prototype.checkError = function (err) {
    if (err) {
        ...
        if (err) throw new Error('OpenCL error. Code: ' + err);
    }
};
