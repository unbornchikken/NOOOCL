...
function CL11() {
    ...
    this.defs = defs;
    this.version = 1.1;
    this.imports = ffi.Library(libName,
        {
            /* Platform APIs */
            ...
            clCreateContext: [ref.refType('void'), [types.ContextProperties, ref.types.uint, types.DeviceIdArray, ref.refType(types.CreateContextNotify), ref.refType('void'), types.ErrorCodeRet]],
            ...
            //                        void *                  /* user_data */,
            //                        cl_int *                /* errcode_ret */) CL_API_SUFFIX__VERSION_1_0;
            clCreateContextFromType: [ref.refType('void'), [types.ContextProperties, types.DeviceType, ref.refType(types.CreateContextNotify), ref.refType('void'), types.ErrorCodeRet]],
            ...
            clEnqueueReadBuffer: ['int', [types.CommandQueue, types.Mem, types.Bool, 'size_t', 'size_t', 'pointer', 'uint', types.EventArray, types.Event]],
            ...
            //                     const cl_event *   /* event_wait_list */,
            //                     cl_event *         /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueWriteBuffer: ['int', [types.CommandQueue, types.Mem, types.Bool, 'size_t', 'size_t', 'pointer', 'uint', types.EventArray, types.Event]],
            ...
            //                   const cl_event *    /* event_wait_list */,
            //                    cl_event *          /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueCopyBuffer: ['int', [types.CommandQueue, types.Mem, types.Mem, 'size_t', 'size_t', 'size_t', 'uint', types.EventArray, types.Event]],
            ...
            //                   const cl_event *     /* event_wait_list */,
            //                   cl_event *           /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueReadImage: ['int', [types.CommandQueue, types.Mem, types.Bool, types.SizeTArray, types.SizeTArray, 'size_t', 'size_t', 'pointer', 'uint', types.EventArray, types.Event]],
            ...
            //                   const cl_event *    /* event_wait_list */,
            //                    cl_event *          /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueWriteImage: ['int', [types.CommandQueue, types.Mem, types.Bool, types.SizeTArray, types.SizeTArray, 'size_t', 'size_t', 'pointer', 'uint', types.EventArray, types.Event]],
            ...
            //                   const cl_event *     /* event_wait_list */,
            //                   cl_event *           /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueCopyImage: ['int', [types.CommandQueue, types.Mem, types.Mem, types.SizeTArray, types.SizeTArray, types.SizeTArray, 'uint', types.EventArray, types.Event]],
            ...
            //                           const cl_event * /* event_wait_list */,
            //                           cl_event *       /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueCopyImageToBuffer: ['int', [types.CommandQueue, types.Mem, types.Mem, types.SizeTArray, types.SizeTArray, 'size_t', 'uint', types.EventArray, types.Event]],
            ...
            //                           const cl_event * /* event_wait_list */,
            //                           cl_event *       /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueCopyBufferToImage: ['int', [types.CommandQueue, types.Mem, types.Mem, 'size_t', types.SizeTArray, types.SizeTArray, 'uint', types.EventArray, types.Event]],
            ...
            //                   cl_event *       /* event */,
            //                   cl_int *         /* errcode_ret */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueMapBuffer: ['pointer', [types.CommandQueue, types.Mem, types.Bool, types.MapFlags, 'size_t', 'size_t', 'uint', types.EventArray, types.Event, ref.refType('int')]],
            ...
            //                  cl_event *        /* event */,
            //                  cl_int *          /* errcode_ret */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueMapImage: ['pointer', [types.CommandQueue, types.Mem, types.Bool, types.MapFlags, types.SizeTArray, types.SizeTArray, ref.refType('size_t'), ref.refType('size_t'), 'uint', types.EventArray, types.Event, ref.refType('int')]],
            ...
            //                        const cl_event *  /* event_wait_list */,
            //                        cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueUnmapMemObject: ['int', [types.CommandQueue, types.Mem, 'pointer', 'uint', types.EventArray, types.Event]],
            ...
            //                       const cl_event * /* event_wait_list */,
            //                       cl_event *       /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueNDRangeKernel: ['int', [types.CommandQueue, types.Kernel, 'uint', types.SizeTArray, types.SizeTArray, types.SizeTArray, 'uint', types.EventArray, types.Event]],
            ...
            //              const cl_event *  /* event_wait_list */,
            //              cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueTask: ['int', [types.CommandQueue, types.Kernel, 'uint', types.EventArray, types.Event]],
            ...
            //                      const cl_event *  /* event_wait_list */,
            //                      cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
            clEnqueueNativeKernel: ['int', [types.CommandQueue, types.EnqueueNativeKernelUserFunc, 'pointer', 'size_t', 'uint', types.MemArray, ref.refType(ref.refType('void')), 'uint', types.EventArray, types.Event]],
            ...
            clCreateSubBuffer: [types.Mem, [types.Mem, types.MemFlags, types.BufferCreateType, ref.refType('void'), types.ErrorCodeRet]],

            //extern CL_API_ENTRY cl_int CL_API_CALL
            //clSetMemObjectDestructorCallback(  cl_mem /* memobj */,
            //                                    void (CL_CALLBACK * /*pfn_notify*/)( cl_mem /* memobj */, void* /*user_data*/),
            //                                    void * /*user_data */ )             CL_API_SUFFIX__VERSION_1_1;
            clSetMemObjectDestructorCallback: ['int', [types.Mem, types.SetEventCallbackCallback, ref.refType('void')]],
            ...
            //                    void *      /* user_data */) CL_API_SUFFIX__VERSION_1_1;
            clSetEventCallback: ['int', [types.Event, 'int', types.SetEventCallbackCallback, ref.refType('void')]],
            ...
            */
            ...
            /*
             cl_int clEnqueueMarker (
                ...
                cl_event *event)
             */
            clEnqueueMarker: ['int', [types.CommandQueue, types.Event]],
            ...
            /*
             ...
             cl_event *event)
             */
            clEnqueueBarrier: ['int', [types.CommandQueue]],
            ...
            /*
             cl_mem clCreateImage2D (
                 ...
                 cl_int *errcode_ret)
             */
            clCreateImage2D: [types.Mem, [types.MemFlags, types.ImageFormatRef, 'size_t', 'size_t', 'size_t', 'pointer', types.ErrorCodeRet ]],
