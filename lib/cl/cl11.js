...
var lib11 = ffi.Library(libName,
    {
        ...
        //                        const cl_event *  /* event_wait_list */,
        //                        cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
        clEnqueueUnmapMemObject: bridjs.defineFunction('int', types.CommandQueue, types.Mem, 'pointer',
            'uint', types.EventArray, types.Event).bind("clEnqueueUnmapMemObject"),
        ...
        //                       const cl_event * /* event_wait_list */,
        //                       cl_event *       /* event */) CL_API_SUFFIX__VERSION_1_0;
        clEnqueueNDRangeKernel: bridjs.defineFunction('int', types.CommandQueue, 'pointer',
            'uint', ref.refType('size_t'), ref.refType('size_t'), ref.refType('size_t'),
            'uint',
            types.EventArray, types.Event).bind("clEnqueueNDRangeKernel"),
        ...
        //              const cl_event *  /* event_wait_list */,
        //              cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
        clEnqueueTask: bridjs.defineFunction('int', types.CommandQueue, 'pointer',
            'uint', types.EventArray, types.Event).bind("clEnqueueTask"),
        ...
        //                      const cl_event *  /* event_wait_list */,
        //                      cl_event *        /* event */) CL_API_SUFFIX__VERSION_1_0;
        clEnqueueNativeKernel: bridjs.defineFunction('int', types.CommandQueue, 'pointer', bridjs.byPointer(Type.enqueueNativeKernelUserFunc),
            'pointer', 'size_t', 'uint', types.Mem, bridjs.byPointer(bridjs.NativeValue.pointer), 'uint', types.EventArray, types.Event).bind("clEnqueueNativeKernel")
    });
