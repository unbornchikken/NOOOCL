...
var types = {
    ...
    ImageFormatPtr: ImageFormat.ref(),
    ImageDesc: ImageDesc,
    ImageDescPtr: ImageDesc.ref(),
    BufferRegionPtr: BufferRegion.ref(),
    ...
    intptrT: ref.types.pointer,
    devicePartitionProperty: ref.types.pointer,//typedef intptr_t            cl_device_partition_property;
    deviceAffinityDomain: ref.types.uint64,//typedef cl_bitfield         cl_device_affinity_domain;
    contextProperties: ref.types.pointer,//typedef intptr_t            cl_context_properties;
    ...
    mem: ref.types.pointer,
    platformId: ref.types.pointer,
    deviceId: ref.types.pointer,
    commandQueue: ref.types.pointer,
    context: ref.types.pointer,
...
CL11.prototypes._lib11 = ffi.DynamicLibrary(libName,
    {
        /* Platform APIs */
        ...
        createContext: bridjs.defineFunction(ref.types.pointer, ref.types.uint, ref.types.pointer,
            ref.refType(types.createContextNotify),
            ref.types.pointer, ref.refType(ref.types.int)).bind("clCreateContext"),
        ...
        //                        void *                  /* user_data */,
        //                        cl_int *                /* errcode_ret */) CL_API_SUFFIX__VERSION_1_0;
        createContextFromType: bridjs.defineFunction(ref.types.pointer, ref.types.pointer, types.deviceType,
            ref.refType(types.createContextNotify),
            ref.types.pointer, ref.refType(ref.types.int)).bind("clCreateContextFromType")
    });
