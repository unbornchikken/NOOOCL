...
var types = {
    ...
    ImageFormatArray: ArrayType(ImageFormat),
    ImageDesc: ImageDesc,
    ...
    DevicePartitionProperty: ArrayType('int'),//typedef intptr_t            cl_device_partition_property;
    DeviceAffinityDomain: ref.types.uint64,//typedef cl_bitfield         cl_device_affinity_domain;
    ContextProperties: ArrayType('int'),//typedef intptr_t            cl_context_properties;
    ...
    KernelArray: ArrayType(types.Kernel),
    Event: ref.refType('void'),
    EventArray: ArrayType(types.Kernel),
    Binary: ArrayType('byte'),
    Binaries: ArrayType(types.Binary),
